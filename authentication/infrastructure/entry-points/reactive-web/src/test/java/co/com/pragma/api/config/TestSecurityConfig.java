    ...
    public SecurityWebFilterChain testSecurityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        .pathMatchers("/validation", "/unauthorized", "/notfound", "/badrequest", "/illegal").permitAll()
                        .pathMatchers(ApiPaths.LOGIN).permitAll()
                        .pathMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**").permitAll()
                        .pathMatchers(ApiPaths.USERS, ApiPaths.USERS + "/**").access(this::isAdminOrAsesor)
